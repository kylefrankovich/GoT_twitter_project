...
fileName = 'GoT_search_ep5_48_hrs_{}.txt'.format(datestr) # We'll store the tweets in a text file.
paramFileName = 'GoT_search_ep5_48_hrs_script_parameters_{}.txt'.format(datestr) # let's output the parameters used for each search in small text file
...
search_from_date = '2016-05-22'

search_to_date = '2016-05-24' # will search up to beginning (midnight) of this date
