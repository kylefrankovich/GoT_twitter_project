...
fileName = 'GoT_search_ep9_48_hrs_{}.txt'.format(datestr) # We'll store the tweets in a text file.
paramFileName = 'GoT_search_ep9_48_hrs_script_parameters_{}.txt'.format(datestr) # let's output the parameters used for each search in small text file
...
search_from_date = '2016-06-19'

search_to_date = '2016-06-21' # will search up to beginning (midnight) of this date
